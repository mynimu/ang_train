...
export class AppComponent {
  ...
  emp2: Employee = { firstName : 'test', lastName : 'test', id : 2, mobile : '123456789', mail : 'test@mymail.at', department : 'dep1'};
  ...
  test() {
    this.figo.accounts().then(a => this.result = a).catch(a => this.result = 'Error '+a);
  }
}
